...
const SessionRow = ({ name, type, time, date, status }: any) => (
...
const LogEntry = ({ patient, date, type, text }: any) => (
...
const QueryCard = ({ name, text, time, priority }: any) => (
...
const MemberCard = ({ name, stage, progress }: any) => (
