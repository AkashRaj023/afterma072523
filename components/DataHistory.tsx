...
import { X, ShieldCheck, Calendar, Droplet, Moon, Pill, Activity, Trash2, Edit2, Info } from 'lucide-react';
...
const DataHistory: React.FC<DataHistoryProps> = ({ logs, onClose, onDeleteLog }) => {
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
